...
public class UpgradePremiumDetailsActivity extends AppCompatActivity {
    ...
    public void bottompopup() {
        final BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(UpgradePremiumDetailsActivity.this, R.style.BottomSheetDialogTheem);
        ...
        tvblock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UpgradePremiumDetailsActivity.this.runOnUiThread(new Runnable() {
                    public void run() {
...
//                }
                ...
                try {
                    ...
                    BlockedNumber blockedNumber = new BlockedNumber(type, "+91", nMobile,Name);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upgrade_premium_details);

        blockedNumberDao = BlockedNumberDatabase.getInstance(UpgradePremiumDetailsActivity.this).blockedNumberDao();
        ...
        tvblock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BlockedNumberDao blockedNumberDao = BlockedNumberDatabase.getInstance(UpgradePremiumDetailsActivity.this).blockedNumberDao();
...
//                        tvblock.setText("BLOCK");
                    ...
                    TelecomManager telecomManager = (TelecomManager) UpgradePremiumDetailsActivity.this.getSystemService(Context.TELECOM_SERVICE);
...
//                        tvblock.setText("BLOCK");
        ...
        llmess.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent inten = new Intent(UpgradePremiumDetailsActivity.this, ContactDetailsActivity.class);
        ...
        llchat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edit.apply();
                Intent intent = new Intent(UpgradePremiumDetailsActivity.this, ChatActivity.class);
        ...
        defaultpopupnew = new simselectpopup(UpgradePremiumDetailsActivity.this);
...
//        }
        ...
        if (img != null) {
            if (img.equalsIgnoreCase("NA")) {
                ...
                cimage.setVisibility(View.VISIBLE);
                mlinear.setVisibility(View.GONE);
                Glide.with(UpgradePremiumDetailsActivity.this)
                        .load(img)
                        .centerCrop()
                        .placeholder(R.drawable.profile)
                        .into(cimage);
    ...
    private void refershAds() {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            ...
            public void onAdFailedToLoad(int i) {
                ...
                Toast.makeText(UpgradePremiumDetailsActivity.this, "Failed to load ad", Toast.LENGTH_SHORT).show();
