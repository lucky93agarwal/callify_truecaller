...
import com.gpslab.kaun.model.WidgetProvider;
...
public class SmsReceiver extends BroadcastReceiver {
     ...
     */
    private static final String SORT = CallLog.Calls.DATE + " DESC";
...
//        }
  //      while (updateNewMessageNotification(context, text) <= 0 && count > 0);
     ...
     */
    public static int updateNewMessageNotification(final Context context, final String text) {
