...
import com.gpslab.kaun.model.IOUtils;
...
public final class Message {
     ...
     */
    public static final String SORT_USD = CallLog.Calls.DATE + " ASC";

    /**
     * Cursor's sort, normal.
     */
    public static final String SORT_NORM = CallLog.Calls.DATE + " DESC";

    /**
     * Type for incoming sms.
     */
    public static final int SMS_IN = CallLog.Calls.INCOMING_TYPE;

    /**
     * Type for outgoing sms.
     */
    public static final int SMS_OUT = CallLog.Calls.OUTGOING_TYPE;
    ...
    /**
     * Get a {@link View.OnLongClickListener} to save the attachment.
     *
     * @param context {@link Context}
     * @return {@link View.OnLongClickListener}
     */
    public View.OnLongClickListener getSaveAttachmentListener(final Activity context) {
