...
public class ContectAPIAdapter extends RecyclerView.Adapter<ContectAPIAdapter.ViewHolder> {
    public static Context mcontext;

    public boolean run = false;
    public static List<GetApiSearchData> productList;
    public static boolean runtimer = true;
    public Context context;
    ViewHolder view;
    private OnItemClickListener listener;
    public GetApiSearchData getselfdata;
    String Contest = "";

    public interface OnItemClickListener {
        void onItemClick(GetApiSearchData item);
    }
    ViewHolder viewHolder;

    public ContectAPIAdapter(Context context, List<GetApiSearchData> productlist, OnItemClickListener listener) {
        super();
    ...
    public void filterList(ArrayList<GetApiSearchData> filteredList) {
...
//        Glide.with(mcontext).load(productList.get(i).getIcon()).apply(new RequestOptions().placeholder(R.mipmap.ic_launcher)).into(viewHolder.ivicon);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout mlinearLayout,mmlinear,mmdetailsllpage;
        //        private FirebaseFirestore firebaseFirestore;
//        DatabaseReference rootRef;
        public AlertDialog alertDialog;


        private simselectpopup defaultpopupnew;
...
//                    Intent inten = new Intent(mcontext, UpgradePremiumDetailsActivity.class);
...
//                    mcontext.startActivity(inten);
            ...
            mmlinear.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    listener.onItemClick(productList.get(getAdapterPosition()));
//                    Intent inten = new Intent(mcontext, UpgradePremiumDetailsActivity.class);
