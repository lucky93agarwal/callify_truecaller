...
public class NewCallsAdapter extends RealmRecyclerViewAdapter<FireCall, NewCallsAdapter.PhoneCallHolder> {
    ...
    public NewCallsAdapter(@Nullable OrderedRealmCollection<FireCall> data,
