...
import com.gpslab.kaun.view.TextViewWithShapeBackground;
import com.gpslab.kaun.view.TimeHelper;
import com.gpslab.kaun.view.User;
import com.gpslab.kaun.view.UserStatuses;
...
import static com.gpslab.kaun.view.FontUtil.isFontExists;

public class StatusNewAdapter extends RealmRecyclerViewAdapter<UserStatuses, StatusNewAdapter.StatusHolder> {
    ...
    public StatusNewAdapter(@Nullable OrderedRealmCollection data, boolean autoUpdate, Context context, OnClickListener onStatusClick) {
