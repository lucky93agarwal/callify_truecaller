...
public class ContectAPIMoreAdapter extends RecyclerView.Adapter<ContectAPIMoreAdapter.ViewHolder> {
    ...
    public ContectAPIMoreAdapter(Context context, List<GetApiSearchData> productlist) {
        super();
