...
public class SearchMoreContectAdapter extends RecyclerView.Adapter<SearchMoreContectAdapter.ViewHolder> {
    ...
    public SearchMoreContectAdapter(Context context, List<GetContectData> productlist) {
        super();
