...
public class MessageCreator {
    ...
    private static Message createTextMessage(User user, String text,String message_id) {
//        Log.d("sendMessagesendMessage","id  =    "+FireManager.getUid());
//        Log.d("sendMessagesendMessage","user id  =    "+user.getUid());
//        Log.d("sendMessagesendMessage","message_id  =    "+message_id);
        String receiverUid = user.getUid();
        //messageId
        final String pushKey = message_id;
    ...
    private static Message createImageMessage(User user, final String imagePath, boolean fromCamera,String message_id) {
...
//            message.setGroup(true);
    ...
    private static Message createVideoMessage(Context context, User user, final String path,String message_id) {
        ...
        Log.d("createVideoMessage","videoThumb ==  "+videoThumb);
        Log.d("createVideoMessage","thumb ==  "+thumb);
...
//            message.setGroup(true);
    ...
    private static Message createAudioMessage(User user, String filePath, String audioDuration,String message_id) {
        String receiverUid = user.getUid();
        Log.d("PlayButtonclick","onClick   filePath = "+filePath);
        Log.d("PlayButtonclick","onClick   Uid = "+user.getUid());
        Log.d("PlayButtonclick","onClick   audioDuration = "+audioDuration);
        Log.d("PlayButtonclick","onClick   message_id = "+message_id);
        ...
        Log.d("PlayButtonclick","onClick   audioDuration = "+fileExtension);
        Log.d("PlayButtonclick","onClick   file = "+fileSize);
        try {
...
//            message.setGroup(true);
    ...
    private static Message createFileMessage(User user, final String filePath,String message_id) {
        String receiverUid = user.getUid();
...
//            message.setGroup(true);
    ...
    private static List<Message> createContactsMessages(List<ExpandableContact> selectedContacts, User user,String message_id) {

        List<Message> messageList = new ArrayList<>();
        String receiverUid = user.getUid();
        Log.d("MainActivityLL", "Contact message_id ==  ==   " + message_id);
...
//                message.setGroup(true);
    ...
    private static Message createVoiceMessage(User user, String path, String duration,String message_id) {
        String receiverUid = user.getUid();
        final Message message = new Message();
        final String pushKey = message_id;
        message.setLocalPath(path);
...
//            message.setGroup(true);
    ...
    private static Message createLocationMessage(User user, Place place,String message_id) {
        String receiverUid = user.getUid();
        final Message message = new Message();
...
//            message.setGroup(true);
    ...
    public static Message createForwardedMessage(Message mMessage, User user, String fromId) {
        ...
        String newMessageId = user.getUid();
        //change messageId
    ...
    public static Builder builder(User user, int type, String message_id) {
        return new Builder(user, type,message_id);
    }
    ...
    public static class Builder {
        ...
        public Builder(User user, int type,String message_id) {
            this.user = user;
            this.type = type;
        ...
        public List<Message> buildContacts() {
            List<Message> contactsMessages = createContactsMessages(contacts, user,message_id);
        ...
        public Message build() {
            Log.d("FireMangerLucky","type  =    "+type);
            Message message = null;

            switch (type) {
                case MessageType.SENT_TEXT:
                    message = createTextMessage(user, text, message_id);
                    break;
                case MessageType.SENT_IMAGE:
                    message = createImageMessage(user, path, fromCamera,message_id);
                    break;

                case MessageType.SENT_VIDEO:
                    message = createVideoMessage(context, user, path,message_id);
                    break;

                case MessageType.SENT_AUDIO:
                    message = createAudioMessage(user, path, duration,message_id);
                    break;

                case MessageType.SENT_FILE:
                    message = createFileMessage(user, path,message_id);
                    break;

                case MessageType.SENT_VOICE_MESSAGE:
                    message = createVoiceMessage(user, path, duration,message_id);
                    break;

                case MessageType.SENT_LOCATION:
                    message = createLocationMessage(user, place,message_id);
                    break;
            ...
            if (message != null && quotedMessage != null) {
                Log.d("sendMessagesendMessage", "buildContacts  ");
