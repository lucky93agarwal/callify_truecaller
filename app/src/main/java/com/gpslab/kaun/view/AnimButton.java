...
public class AnimButton extends RecordButton {
    ...
    private void initCommon() {
        Log.d("MainActivitRecording","recordingResourceId   =   =  "+recordingResourceId);
        Log.d("MainActivitRecording","typingResourceId   =   =  "+typingResourceId);
    ...
    public void goToState(int state) {
        Log.d("MainActivitRecording","state   =   =  "+state);
    ...
    private Drawable makeDrawable(Drawable drawable, float scale, int alpha) {
        Log.d("MainActivitRecording","drawable   =   =  "+drawable);
        Log.d("MainActivitRecording","scale   =   =  "+scale);
        Log.d("MainActivitRecording","alpha   =   =  "+alpha);
    ...
    private void animate(final Drawable from, final Drawable to) {
        Log.d("MainActivitRecording","from   =   =  "+from);
        Log.d("MainActivitRecording","to   =   =  "+to);
