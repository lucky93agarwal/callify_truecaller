...
open class BaseHolder(val context: Context, itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    private val tvQuotedName: EmojiconTextView? = itemView.findViewById(R.id.tv_quoted_name)
    private val tvQuotedText: EmojiconTextView? = itemView.findViewById(R.id.tv_quoted_text)
    ...
    open fun bind(message: Message, user: User) {
        ...
        progressButton?.setOnClickListener {
            Log.d("BaseHolderBase","progressButton");
            Log.d("BaseHolderBase","adapterPosition  =  "+adapterPosition);
            Log.d("BaseHolderBase","itemView  =   "+itemView);
            Log.d("BaseHolderBase","message   ==  "+message);
