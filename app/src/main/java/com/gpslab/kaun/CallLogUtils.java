...
public class CallLogUtils {
    ...
    private void loadData(){
        ...
        String projection[] = {"_id", CallLog.Calls.NUMBER,CallLog.Calls.DATE,CallLog.Calls.DURATION,CallLog.Calls.TYPE,CallLog.Calls.CACHED_NAME,CallLog.Calls.CACHED_PHOTO_URI};
        ...
        while (!cursor.isAfterLast()){
            ...
            callLogInfo.setImage(cursor.getString(cursor.getColumnIndex(CallLog.Calls.CACHED_PHOTO_URI)));
//            Log.i("checkimagecheck","image = "+cursor.getString(cursor.getColumnIndex(CallLog.Calls.CACHED_PHOTO_URI)));
...
//            callLogInfo.setSimtype(cursor.getString(cursor.getColumnIndex(CallLog.Calls.PHONE_ACCOUNT_ID)));
