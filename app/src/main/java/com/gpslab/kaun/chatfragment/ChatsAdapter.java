package com.gpslab.kaun.chatfragment;
...
public class ChatsAdapter extends RealmRecyclerViewAdapter<Chat, RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if (typingStatHashmap.containsValue(chat.getChatId())) {
            Log.d("ChatsFragmentCheck","New ==   "+"Gone");
            ...
            Log.d("ChatsFragmentCheck","New ==   "+"VISIBLE");
        ...
        String name = "";
        if (user != null){
            Log.d("CheckDataAdapter","User name = 1 ");
            name = user.getUserName();
        }else {
            Log.d("CheckDataAdapter","User name = 2 ");
        }


        Log.d("CheckDataAdapter","User name =  "+name);
        ...
        if (message != null) {
            ...
            if (message.isTextMessage() || message.getType() == MessageType.GROUP_EVENT || MessageType.isDeletedMessage(message.getType())) {
                ...
                if (message.getType() == MessageType.GROUP_EVENT) {
                    ...
                    Log.d("ChatsFragmentCheck","New ==   "+"10 = "+groupEvent);
                    ...
                    Log.d("ChatsFragmentCheck","New ==   "+"8     "+content);
                ...
                Log.d("ChatsFragmentCheck","New ==   "+"4      "+MessageTypeHelper.extractMessageTypeMetadataText(message));
            ...
            Log.d("ChatsFragmentCheck","New ==   "+"2");
    ...
    private void loadUserPhoto(final User user, final ImageView imageView) {
        ...
        if (user.isBroadcastBool())
            ...
            Glide.with(context).load(user.getThumbImg()).placeholder(R.drawable.profile).into(imageView);
