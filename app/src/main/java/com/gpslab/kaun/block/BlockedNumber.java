...
public class BlockedNumber {
    ...
    @ColumnInfo(name = "phone_name") @NonNull
    private final String phoneName;
    @Ignore
    private final PhoneNumberUtil phoneNumberUtil = PhoneNumberUtil.getInstance();

    public BlockedNumber(@NonNull final BlockedNumberType type, @NonNull final Pattern regex, @NonNull final String countryCode, @NonNull final String phoneNumber,@NonNull final String phoneName) {
        this.type = type;
        this.regex = regex;
    ...
    public BlockedNumber(@NonNull final BlockedNumberType type, @NonNull final String countryCode, @NonNull final String number, @NonNull final String name) {
        this.type = type;
