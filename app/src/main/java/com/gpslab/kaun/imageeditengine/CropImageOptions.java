...
public class CropImageOptions implements Parcelable {
    ...
    public IEECropImageView.CropShape cropShape;
    ...
    public IEECropImageView.Guidelines guidelines;

    /** The initial scale type of the image in the crop image view */
    public IEECropImageView.ScaleType scaleType;
    ...
    public IEECropImageView.RequestSizeOptions outputRequestSizeOptions;
    ...
    public CropImageOptions() {
        ...
        cropShape = IEECropImageView.CropShape.RECTANGLE;
        ...
        guidelines = IEECropImageView.Guidelines.ON_TOUCH;
        scaleType = IEECropImageView.ScaleType.FIT_CENTER;
        ...
        outputRequestSizeOptions = IEECropImageView.RequestSizeOptions.NONE;
        noOutputImage = false;
    ...
    protected CropImageOptions(Parcel in) {
        cropShape = IEECropImageView.CropShape.values()[in.readInt()];
        snapRadius = in.readFloat();
        touchRadius = in.readFloat();
        guidelines = IEECropImageView.Guidelines.values()[in.readInt()];
        scaleType = IEECropImageView.ScaleType.values()[in.readInt()];
        ...
        outputRequestSizeOptions = IEECropImageView.RequestSizeOptions.values()[in.readInt()];
