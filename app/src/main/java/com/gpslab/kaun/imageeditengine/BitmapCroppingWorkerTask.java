...
final class BitmapCroppingWorkerTask
    ...
    private final IEECropImageView.RequestSizeOptions mReqSizeOptions;
    ...
    BitmapCroppingWorkerTask(
            ...
            IEECropImageView.RequestSizeOptions options,
            Uri saveUri,
    ...
    protected void onPostExecute(Result result) {
        if (result != null) {
            ...
            if (!isCancelled()) {
                IEECropImageView cropImageView = mCropImageViewReference.get();
